...
function Registration(){
    ...
    function CreateAccount(e) {
            if(password === passwordConfirmed){
                ...
                .catch((error) => {
                    ...
                    switch (error.code){
                        case "auth/email-already-in-use":
                            setTextError("Exista deja un user cu acest email!");
                            break;
                ...
                setTextError("Parolele trebuie să coincidă!");
            }          
    }
        return (
            <>
                                ...
                                <FormGroup>
                                    ...
                                    <FormMobile>
                                        <FormMobileSection>
                                            ...
                                            <FormSelect type="tel" value={mobile} onChange={handleMobile} required>
                                        ...
                                        <FormMobileSection>
                                            <FormLabel htmlFor='for'>Mobil</FormLabel>
                                            <FormInput type="tel" value={mobile} onChange={handleMobile} required />
                                        </FormMobileSection>
                                    </FormMobile>
                                    <FormLabel htmlFor='for'>Ocupatie</FormLabel>
                                    <FormSelect value={occupation} onChange={handleOccupation} required>
                                        <option value="default">Selecteaza</option>
                                    ...
                                    <FormInput type='password' value={passwordConfirmed} onChange={handleConfirmedPassword} placeholder="*******" required/>
                                    <FormButton onClick={CreateAccount}>Crează cont</FormButton>
                                    <Text to="/signin">Deja am cont!</Text>
